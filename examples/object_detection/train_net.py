...
import wandb
wandb.login(key="c6e760235f765c42c078a25cd730883016c20bb1")
...
def main(args):
    ...
    register_coco_instances(
        "publaynet_train",
        {},
        cfg.PUBLAYNET_DATA_DIR_TRAIN + "/_annotations.coco.json",
    ...
    register_coco_instances(
        "publaynet_val",
        {},
        cfg.PUBLAYNET_DATA_DIR_TEST + "/_annotations.coco.json",
